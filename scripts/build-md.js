        ...
        if (x.endsWith('.md')) {
            fs.readFile(x, 'utf8', (err, file) => {
                ...
                if (!frontmatter.permalink) {
                    console.error(
                        'Skipping ' + x + ': no frontmatter permalink.'
                    );
                } else {
                    ...
                    frontmatter.head.scripts = [
                        ...(frontmatter.scripts ?? []),
                        'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.58.3/codemirror.min.js',
                        'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.58.3/mode/javascript/javascript.min.js',
                        'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.58.3/mode/xml/xml.min.js',
                    ];
                    ...
                    fs.writeFile(
                        dest + '.md',
                        matter.stringify(
                            upgradeCodeFences(graymatter.content),
                            frontmatter
                        )
                    );
                }
...
run('./submodules/web-components/src/');
